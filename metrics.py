...
def interactive_scatter_plot(df):
    ...
    fig.update_layout(updatemenus=[dict(type='buttons', showactive=False, buttons=[dict(label='Compute R2', method='update', args=[{'selectedPoints': fig.selectedpoints}, update_r2_text])])])
